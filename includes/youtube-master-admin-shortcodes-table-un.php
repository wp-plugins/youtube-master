...
<table class="widefat fixed" cellspacing="0">
	<thead>
		<tr>
			...
			<th id="columnname" class="manage-column column-columnname" scope="col" width="200"><legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Universal Shortcode', 'youtube_master'); ?></h3></legend></th>
...
<p class="submit"><input class='button-primary' type='submit' name='update' value='<?php _e("Save Shortcode UN", 'youtube_master'); ?>' id='submitbutton' /></p>
</fieldset>
</form>
<?php
	}
