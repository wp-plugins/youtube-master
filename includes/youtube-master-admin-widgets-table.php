...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			...
			<td class="column-columnname"style="vertical-align:middle"><h3>Youtube Buttons Widget</h3><p>The perfect widget to make your Youtube channel grow exponentially.</p><p>We packed the Youtube Subscribe Channel button with <b>Full Layout</b> that shows the Youtube User Avatar or profile picture and <b>Default Layout</b> that only shows subscribe button and bubble count. This widget works great when published under any of the widget players.</p><p>Navigate to your Widgets page and start using it.</p></td>
		</tr>
		<tr>
