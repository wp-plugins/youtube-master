...
<?php
if(!class_exists('youtube_master_admin_shortcodes_table_in')){
	require_once( dirname( __FILE__ ) . '/youtube-master-admin-shortcodes-table-in.php');
}
//Prepare Table of elements
$wp_list_table = new youtube_master_admin_shortcodes_table_in();
//Table of elements
...
<?php
if(!class_exists('youtube_master_admin_shortcodes_table_un')){
	require_once( dirname( __FILE__ ) . '/youtube-master-admin-shortcodes-table-un.php');
}
//Prepare Table of elements
$wp_list_table = new youtube_master_admin_shortcodes_table_un();
//Table of elements
$wp_list_table->display();
?>
</br>
