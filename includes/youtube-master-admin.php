...
<h2><?php _e("Youtube Master LITE Version", 'youtube_master'); ?></h2>
<br>
...
<h3><img src="<?php echo plugins_url('../images/techgasp-minilogo.png', __FILE__); ?>" style="width:40px; vertical-align:middle;" alt="' . esc_attr__( 'TechGasp Plugins') . '" /> Youtube Master Website</h3>
<p><a class="button-secondary" href="http://wordpress.techgasp.com/youtube-master/" target="_blank" title="Youtube Master Info Page">Info Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/youtube-master-documentation/" target="_blank" title="Youtube Master Documentation">Documentation</a> <a class="button-primary" href="http://wordpress.techgasp.com/youtube-master/" target="_blank" title="Youtube Master Advanced Version">Advanced Version</a></p>
</form>
</div>