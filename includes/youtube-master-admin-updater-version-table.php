...
class youtube_master_admin_updater_version_table extends WP_List_Table {
	 ...
	 */
function display() {
global $youtube_plugin_slug;
?>
<table class="widefat fixed" cellspacing="0">
	<thead>
		<tr>
			<th id="columnname" class="manage-column column-columnname" scope="col" width="300"><legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Plugin', 'youtube_master'); ?></h3></legend></th>
...
$youtube_plugin_slug = 'youtube-master/youtube-master.php';
	echo '<a class="button-primary" href="'.wp_nonce_url( self_admin_url('update.php?action=upgrade-plugin&plugin=') . $youtube_plugin_slug, 'upgrade-plugin_' . $youtube_plugin_slug) .'" title="Update">Update</a></td>';
}
?>
			</th>
		</tr>
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><h2><b><?php echo get_option( 'youtube_master_name' ); ?></b></h2></td>
